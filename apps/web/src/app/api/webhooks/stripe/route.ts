...
// Note: In Next.js App Router, route handlers don't have automatic body parsing,
// so no config is needed. We use request.text() to get the raw body for Stripe signature verification.
