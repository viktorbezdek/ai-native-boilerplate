...
description: Configure and manage deployments to Vercel with environment management, preview deploys, and rollback procedures. Includes risk profiles and deployment safety checks. Use when setting up deployment pipelines, configuring environments, or troubleshooting deployment issues.
allowed-tools:
  - Read
  - Write
  - Edit
