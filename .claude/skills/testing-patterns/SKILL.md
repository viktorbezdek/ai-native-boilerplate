...
description: Write effective unit, integration, and E2E tests using Vitest and Playwright. Use when writing tests, improving coverage, or debugging test failures.
