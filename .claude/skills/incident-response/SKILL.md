...
description: Handle production incidents with structured runbooks, escalation procedures, and postmortem templates. Use when responding to outages, investigating errors, or writing postmortems.
allowed-tools: Read, Write, Bash, mcp__sentry__*, mcp__vercel__*, mcp__github__*
---
