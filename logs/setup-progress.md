...
- [ ] TDD CLAUDE.md (overview, @imports, critical rules)
- [ ] TDD basic hooks in `.claude/settings.json`
- [ ] TDD protected-file guard hook
- [ ] Interactive env var configuration
...
**Restart Claude Code** (or run `/reload`) to load the new tdd-cycle skill.

Then say: `Continue Phase 1`
